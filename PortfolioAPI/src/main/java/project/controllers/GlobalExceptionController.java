...
public class GlobalExceptionController {
	...
	public ResponseEntity<?> handleValidationError(MethodArgumentNotValidException ex) {
		if (ex.getBindingResult().getFieldError() != null) {
			...
			ErrorModel message = getErrorMessage(error.getCode(), error.getArguments(), error.getField(), HttpStatus.BAD_REQUEST);
			return new ResponseEntity<>(message, HttpStatus.BAD_REQUEST);
			// @formatter:on
		} else {
	...
	public ResponseEntity<?> handleMethodNotSupported(HttpRequestMethodNotSupportedException ex) {
		...
		ErrorModel message = getErrorMessage("exception.method_not_supported", args, null, HttpStatus.METHOD_NOT_ALLOWED);
	...
	public ResponseEntity<?> handleMediaTypeNotSupported(HttpMediaTypeNotSupportedException ex) {
		...
		ErrorModel message = getErrorMessage("exception.media_type_not_supported", args, null, HttpStatus.UNSUPPORTED_MEDIA_TYPE);
